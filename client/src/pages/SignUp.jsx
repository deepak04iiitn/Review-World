              ...
              <div className="space-y-4 md:space-y-8">
                <div className="space-y-2 md:space-y-4">
                  <h2 className="text-2xl md:text-4xl font-bold text-white leading-tight">
                    Share Your Voice,<br />Shape the Community
                  </h2>
                  <p className="text-lg md:text-xl text-blue-50 leading-relaxed">
                    Join a thriving community of reviewers who help others make better decisions through authentic experiences.
                  </p>
                </div>
          ...
          <div className="max-w-md w-full space-y-6 md:space-y-8">
            ...
            <form onSubmit={handleSubmit} className="mt-6 md:mt-8 space-y-4 md:space-y-6">
              ...
              <p className="text-center text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="/sign-in" className="font-medium text-blue-600 hover:text-blue-500 transition-colors duration-200">
                  Sign in instead
                </a>
              </p>
            </form>
