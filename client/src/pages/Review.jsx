    ...
    <main className="p-6 bg-gray-50 dark:bg-gray-900 transition-colors duration-300 min-h-screen relative">
      ...
      {review && !loading && !error && (
        <div className="relative">
          ...
          {/* Link Copied Message */}
          {copied && (
            <p className="fixed top-[23%] right-[5%] z-10 rounded-md bg-blue-600 dark:bg-blue-500 text-white p-2 transition-opacity duration-500 ease-in-out opacity-0 animate-fade-in">
              Link copied!
            </p>
          )}
          ...
          <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-lg transition-transform hover:scale-[1.02] duration-500 ease-in-out border border-gray-200 dark:border-gray-700 mb-6">
            ...
            <div className="relative flex space-x-4">
              {/* Chat with Reviewer Button */}
              <div className="relative flex-1 group">
                <Button gradientDuoTone='purpleToPink' className='w-full px-6 py-2 rounded-md shadow-md flex items-center space-x-2'>
              ...
              {/* Summarize the Review Button */}
              <div className="relative flex-1 group">
                <Button gradientDuoTone='cyanToBlue' className='w-full px-6 py-2 rounded-md shadow-md flex items-center space-x-2'>
