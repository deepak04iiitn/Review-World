  ...
  const features = [
    {
      ...
      description:
        "Visualize review trends and patterns across different categories with interactive charts",
    },
    {
      icon: <MessageCircle size={24} />,
      title: "Direct Connect",
      description:
        "Chat directly with reviewers to get detailed insights and ask specific questions",
    },
    {
      icon: <ArrowLeftRight size={24} />,
      title: "Compare Categories",
      description:
        "Side-by-side comparison of reviews across different product categories",
    },
    {
      icon: <FileText size={24} />,
      title: "AI Summary",
      description:
        "Get instant AI-generated summaries of multiple reviews for quick insights",
    },
    {
      icon: <Search size={24} />,
      title: "Advanced Search",
      description:
        "Find exactly what you need with filters for price, rating, date, and more",
    },
    {
      icon: <SortDesc size={24} />,
      title: "Smart Sorting",
      description:
        "Sort reviews by relevance, helpfulness, recency, or rating distribution",
    },
  ];
      ...
      >
        <div className="max-w-4xl mx-auto text-center pt-20">
          ...
          <img
            ...
            alt="Review4All Logo"
            className="mx-auto mb-4 h-28 w-50" // Centered and sized appropriately
          />
          {/* Name */}
